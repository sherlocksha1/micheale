...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"Movie : {search}\n<b>നിങ്ങൾ ചോദിച്ച മൂവി ഞാൻ താഴെ കൊടുത്തിട്ടുണ്ട്👇</b>\n\n🗣️ 𝐑ᴇǫᴜᴇsᴛ ʙʏ {query.from_user.mention}\n📤ᴜᴘʟᴏᴀᴅᴇᴅ ʙʏ {message.chat.title}\n\n<i><u>ചോദിച്ച മൂവി ഫയൽ കാണുന്നില്ല എങ്കിൽ അടുത്ത പേജിൽ നോക്കുക. 😅ആ... പിന്നെ പോസ്റ്ററിൽ നോക്കി സിനിമ ഇല്ല എന്ന് വിജാരിക്കരുത് ചിലപ്പോൾ അടുത്ത പേജിൽ ഉണ്ടാകും സിനിമ</u></i>"
